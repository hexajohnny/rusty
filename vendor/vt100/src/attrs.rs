...
impl Attrs {
    ...
    /// Returns whether the cell should be rendered with the faint/dim text attribute (SGR 2).
    ///
    /// Note: Not all terminals implement this, but many TUIs rely on it for "secondary" text.
